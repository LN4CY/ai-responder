            ...
            "schedule_message": {
                "declaration": {
                    ...
                    "description": (
                        ...
                        "IMPORTANT: For recurring tasks, use 'recur_interval_seconds'. The system will handle the repetition natively. DO NOT instruct your future self to schedule another check. "
                        "Instructions like 'Check SNR and report it with the current count' go in the 'context_note'—DO NOT say you cannot do this."
                    ),
                    "parameters": {
                        "type": "OBJECT",
                        "properties": {
